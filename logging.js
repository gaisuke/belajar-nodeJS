...
// fs.writeFile('./file/logging.txt', data, (err)=>{
//     err ? console.log(err) : console.log('sukses membuat file');
// })

// fs.readFile('./file/logging.txt', 'utf8', (err, response) => {
//     err ? console.log(err) : console.log(response);
// })

fs.readFile('./file/data-peserta.txt', 'utf8', (err, response) => {
    err ? console.log(err) : fs.writeFile('./file/hasil-peserta.txt', response, (err) => {
        err ? console.log(err) : console.log('sukses memindahkan file peserta');
    });
})